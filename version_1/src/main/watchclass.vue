<template>
  ...
  <div style="font-family: youyuan;font-size: 20px;font-weight: bolder;color: rgb(96, 154, 236);margin-top: 50px;">班级间学科成绩比较
  </div>
  <div class="main">
    <div class="second">
      <span>考试名称：</span>
  ...
  <div style="font-family: youyuan;font-size: 20px;font-weight: bolder;color: rgb(218, 68, 13);margin-top: 50px;">总成绩分析
  </div>
